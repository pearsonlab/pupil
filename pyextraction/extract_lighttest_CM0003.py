...
def pupil_extract(datafile_input_path,
    ...
    cs_x = np.array(df['time'])  # Cubic spline input x-values
    ...
    extracted_dvs['baseline_pupil_diameter'] = [D_zero_trial0, D_zero_trial2, D_zero_trial3]
    extracted_dvs_avg['baseline_pupil_diameter_avg'] = [np.nanmean([D_zero_trial0, D_zero_trial2, D_zero_trial3])]
    extracted_dvs_avg['baseline_pupil_diameter_std'] = [np.nanstd([D_zero_trial0, D_zero_trial2, D_zero_trial3])]
    ...
    extracted_dvs['maximal_pupillary_constriction'] = [D_m_trial0, D_m_trial2, D_m_trial3]
    extracted_dvs_avg['maximal_pupillary_constriction_avg'] = [np.nanmean([D_m_trial0, D_m_trial2, D_m_trial3])]
    extracted_dvs_avg['maximal_pupillary_constriction_std'] = [np.nanstd([D_m_trial0, D_m_trial2, D_m_trial3])]
    ...
    extracted_dvs['constriction_amplitude'] = [A_trial0, A_trial2, A_trial3]
    extracted_dvs_avg['constriction_amplitude_avg'] = [np.nanmean([A_trial0, A_trial2, A_trial3])]
    extracted_dvs_avg['constriction_amplitude_std'] = [np.nanstd([A_trial0, A_trial2, A_trial3])]
    ...
    extracted_dvs['plr_latency'] = [t_L_trial0, t_L_trial2, t_L_trial3]
    extracted_dvs_avg['plr_latency_avg'] = [np.nanmean([t_L_trial0, t_L_trial2, t_L_trial3])]
    extracted_dvs_avg['plr_latency_std'] = [np.nanstd([t_L_trial0, t_L_trial2, t_L_trial3])]
    ...
    extracted_dvs['constriction_time'] = [t_C_trial0, t_C_trial2, t_C_trial3]
    extracted_dvs_avg['constriction_time_avg'] = [np.nanmean([t_C_trial0, t_C_trial2, t_C_trial3])]
    extracted_dvs_avg['constriction_time_std'] = [np.nanstd([t_C_trial0, t_C_trial2, t_C_trial3])]
    ...
    # Get index of closest time point
    ...
    extracted_dvs['recovery_time'] = [t_R_trial0, t_R_trial2, t_R_trial3]
    extracted_dvs_avg['recovery_time_avg'] = [np.nanmean([t_R_trial0, t_R_trial2, t_R_trial3])]
    extracted_dvs_avg['recovery_time_std'] = [np.nanstd([t_R_trial0, t_R_trial2, t_R_trial3])]
    ...
    extracted_dvs['relative_constriction'] = [R_C_trial0, R_C_trial2, R_C_trial3]
    extracted_dvs_avg['relative_constriction_avg'] = [np.nanmean([R_C_trial0, R_C_trial2, R_C_trial3])]
    extracted_dvs_avg['relative_constriction_std'] = [np.nanstd([R_C_trial0, R_C_trial2, R_C_trial3])]
...
if __name__ == '__main__':
    ...
    pupil_extract(
        '../pyanalysis/data/CM0003/lighttest/CM0003_lighttest_norm_pupil.csv',
    ...
    pupil_extract(
        '../pyanalysis/data/CM0003/lighttest/CM0003_lighttest_unnorm_pupil.csv',
