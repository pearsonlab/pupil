...
def show_eyes(controller):
    ...
    left_text = visual.TextStim(controller.testWin, height=0.05, pos=(-0.6,-0.8), units='norm')
    right_text = visual.TextStim(controller.testWin, height=0.05, pos=(0.6,-0.8), units='norm')
    press_text = visual.TextStim(controller.testWin, height=0.05, pos=(0,-0.3), text='Press any button to quit', units='norm')
